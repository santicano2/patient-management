    ...
    <Form {...form}>
      ...
      >
        ...
        <CustomFormField
          ...
          placeholder="Elegir un tipo de identificación"
        >
        ...
        <CustomFormField
          ...
          label="Cargar documento de identificación"
          renderSkeleton={(field) => (
            <FormControl>
        ...
        <CustomFormField
          ...
          label="Estoy de acuerdo con el manejo de la información"
        />
